                            ...
                            <div class="flex-1 overflow-y-auto p-6 md:p-8 grid grid-cols-1 md:grid-cols-2 gap-8">
                                ...
                                <div class="space-y-6">
                                    ...
                                    <div x-show="activeFrac?.floor_plan">
                                        ...
                                        <a :href="activeFrac?.floor_plan" target="_blank" class="block mb-3 rounded-xl overflow-hidden border border-slate-200 bg-white hover:shadow-lg transition-shadow group relative">
                                            ...
                                            <div class="absolute inset-0 bg-black/0 group-hover:bg-black/10 transition-colors flex items-center justify-center">
                                                <span class="opacity-0 group-hover:opacity-100 transition-opacity bg-white/90 backdrop-blur text-ht-navy px-4 py-2 rounded-full text-xs font-bold uppercase tracking-wider shadow-lg flex items-center gap-2">
                                        ...
                                        <!-- Download Link -->
                                        <a :href="activeFrac?.floor_plan" download target="_blank" class="flex items-center gap-3 bg-ht-blue/10 text-ht-blue p-3 rounded-xl hover:bg-ht-blue hover:text-white transition-colors group">
                                            <svg class="w-6 h-6 opacity-80 group-hover:opacity-100" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4"></path></svg>
                                            <div>
