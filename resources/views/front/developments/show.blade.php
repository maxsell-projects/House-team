                            ...
                            <div class="flex-1 overflow-y-auto p-6 md:p-8 grid grid-cols-1 md:grid-cols-2 gap-8">
                                ...
                                <div class="space-y-6">
                                    ...
                                    <div x-show="activeFrac?.floor_plan">
                                        <h5 class="text-xs font-bold uppercase tracking-widest text-slate-400 mb-3">Planta</h5>
                                        <a :href="activeFrac?.floor_plan" target="_blank" class="flex items-center gap-3 bg-ht-blue/10 text-ht-blue p-4 rounded-xl hover:bg-ht-blue hover:text-white transition-colors group">
                                            <svg class="w-8 h-8 opacity-80 group-hover:opacity-100" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4"></path></svg>
                                            <div>
